...
class FinancialReportPolicy
{
    ...
    {
        return $user->hasAnyPermission(['manage-finances', 'view-reports']);
    }
    ...
    {
        return $user->hasPermission('manage-finances');
    }
     ...
     */
    public function download(User $user, FinancialReport $financialReport): bool
    {
        return $user->hasAnyPermission(['manage-finances', 'view-reports']);
    }

    /**
     * Determine whether the user can regenerate the report.
     */
    public function regenerate(User $user, FinancialReport $financialReport): bool
    {
        return $user->hasPermission('manage-finances');
    }
}